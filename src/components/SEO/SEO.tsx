...
export const SEO = (props: Props) => {
  ...
  return (
    <>
      ...
      <meta property="og:image:secure_url" content={`${seo.url}${seo.image}`} /> 
      <meta property="og:image:width" content="1280"/>
      <meta property="og:image:height" content="720"/>
      <meta property="og:image" content={seo.imageWpp} itemProp="image" />
      <meta property="og:image:secure_url" content={`${seo.url}${seo.imageWpp}`} /> 
      ...
      <meta name="twitter:card:secure_url" content={`${seo.url}${seo.image}`} />
