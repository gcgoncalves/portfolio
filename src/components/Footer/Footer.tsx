...
export const Footer = () => {
  return (
    <footer className='p-5 bg-black w-full'>
      <div className='flex flex-row justify-end  py-0 md:py-5 px-5 gap-5' aria-label='github' title='githib'>
        <a href='https://github.com/gcgoncalves' target='_blank'>
          <div className=' h-8 w-8 bg-cover bg-[url("/images/github.svg")] hover:bg-[url("/images/github-yellow.svg")]'></div>
        </a>
        <a href='https://linkedin.com/in/gcgoncalves' target='_blank' aria-label='linkedin' title='linkedin'>
