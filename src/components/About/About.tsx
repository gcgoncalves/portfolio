  ...
  return (
    <section id='about' className='p-10 md:p-12 bg-black text-yellow-500'>
      <div className='mx-auto my-0 max-w-screen-xl'>
        ...
        <p className='text-xl font-serif md:w-2/3'>I am Gabriel Costa, a Brazilian web developer based in Dublin, Ireland. I have a B.Sc. in Computer Science from Universidade
